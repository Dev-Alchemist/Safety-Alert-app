...
class DatabaseHelper {
  ...
  static late DatabaseHelper _databaseHelper; // this _databaseHelper will
...
//want to initialize the db.
  ...
  void _createDbTable(Database? db, int version) async {
    await db!.execute(
        'CREATE TABLE $contactTable($colId INTEGER PRIMARY KEY AUTOINCREMENT, '
        '$colContactName TEXT, '
        '$colContactNumber TEXT UNIQUE)');
  }
